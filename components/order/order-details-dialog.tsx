...
import { Edit2, Phone, Mail, MapPin, Users, Save, X, Trash2 } from 'lucide-react'
import { Order, OrderItem } from '@/app/types/order'
import { User } from '@/app/types/user'
import { set } from 'date-fns'
import CancelOrderDialog from './client-cancel-order'
...
export function OrderDetailsDialog({
    ...
    return (
        <>
            {selectedOrder?.status === 'pending' && <CancelOrderDialog selectedOrder={selectedOrder} isCancelDialogOpen={isCancelDialogOpen} setIsCancelDialogOpen={setIsCancelDialogOpen} setSelectedOrder={setSelectedOrder} setOrders={setOrders} />}
